...
from pywxdump.db.utils import timestamp2str, type_converter, xml2dict, match_BytesExtra


def get_msg_detail(row, my_talker="我"):
    """
    获取单条消息详情,格式化输出
    """
    ...
    if type_id == (1, 0):  # 文本
        ...
        src = ""
    elif type_id == (49, 0) or type_id == (49, 6):  # 文件
        DictExtra = get_BytesExtra(BytesExtra)
    ...
    row_data = {"id": localId, "MsgSvrID": str(MsgSvrID), "type_name": type_name, "is_sender": IsSender,
                "talker": talker, "room_name": StrTalker, "msg": msg, "src": src, "extra": extra,
                "CreateTime": CreateTime, "Sequence": Sequence,"MsgSequence": MsgSequence}
    return row_data
