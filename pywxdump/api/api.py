...
# from pywxdump.db.fts.parsingFTS import ParsingFTS
...
#
# from pywxdump.db import wxid2userinfo, ParsingMSG, get_user_list, get_recent_user_list, ParsingMediaMSG, \
...
#         return AttachmentContext.FileResponse(img_path_all)
#     else:
...
#             f.write(out_bytes)
#         return AttachmentContext.FileResponse(imgsavepath)
#     else:
#         return ReJson(1001, body=original_img_path)
#
#
...
#         return AttachmentContext.FileResponse(video_save_path)
#     AttachmentContext.download_file(original_img_path, video_save_path)
#     return AttachmentContext.FileResponse(original_img_path)
#
#
...
#         return AttachmentContext.FileResponse(savePath)
#
...
#     if not AttachmentContext.exists(all_file_path):
#         return ReJson(5002)
#     return AttachmentContext.FileResponse(all_file_path)
#
#
# # end 以上为聊天记录相关api *********************************************************************************************
#
